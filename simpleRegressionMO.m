...
addpath('./VHGPR')      % Variational Heteroscedastic Gaussian Process regression [Lazaro-Gredilla, 2011]
...
addpath('./SSGP')       % Sparse Spectrum Gaussian Process (SSGP)  [Lazaro-Gredilla, 2008]
