%
%   SSGP-fixed - Sparse Spectrum Gaussian Processes Regression
%
%   (This version does not learn the spectral points).
%  
...
%
%    [nlml, deriv_nlml] = 
%               ssgprfixed(optimizeparams, x_tr, y_tr)
%   
...
%
%   ***NOTE***
%   In most cases you will prefer to use the front end ssgprfixed_ui.m, that
%   adequately handles initialization and provides error measures. 
%
%   See also: ssgprfixed_ui
%   
...
function [out1, out2] = ssgprfixed(optimizeparams, x_tr, y_tr, x_tst)
...
if nargout == 2
    ...
    % fix representative frequencies
    out2(D+2+1:D+2+D*m)=0;                                              
